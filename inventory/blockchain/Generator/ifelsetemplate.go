	...
	} else if function == "func19" {
		return s.func19(APIstub, args)
	} else if function == "func20" {
		return s.func20(APIstub, args)
	} else if function == "func21" {
		return s.func21(APIstub, args)
	} else if function == "func22" {
		return s.func22(APIstub, args)
	} else if function == "func23" {
		return s.func23(APIstub, args)
	} else if function == "func24" {
		return s.func24(APIstub, args)
	} else if function == "func25" {
		return s.func25(APIstub, args)
	} else if function == "func26" {
		return s.func26(APIstub, args)
	} else if function == "func27" {
		return s.func27(APIstub, args)
	} else if function == "func28" {
		return s.func28(APIstub, args)
	} else if function == "func29" {
		return s.func29(APIstub, args)
	} else if function == "func30" {
		return s.func30(APIstub, args)
	} 
