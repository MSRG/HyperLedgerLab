...
function getResultTitle() {
    ...
    return ['Name', 'Succ', 'Fail', 'TotComTx', 'Send Rate', 'Max Latency', 'Min Latency', 'Avg Latency', 'SuccThrput', 'ComThrput'];
}
    ...
    for (let test of tests) {
        ...
        try {
            ...
            if(!final || testIdx !== tests.length) {
                /*if(testLabel == 'common') {
			logger.info('Waiting 5 minutes for the next round...');
