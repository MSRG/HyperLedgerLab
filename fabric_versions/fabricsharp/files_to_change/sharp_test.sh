...
for l in 10 50 100 
do
 sed -i "23s/.*/        tps: ${l}/" /home/ubuntu/HyperLedgerLab/inventory/blockchain/benchmark/electronic-health-record/config.yaml
#5.txduration
for m in 180 
do
 sed -i "19s/.*/    - ${m}/" /home/ubuntu/HyperLedgerLab/inventory/blockchain/benchmark/electronic-health-record/config.yaml
#6. BlockSize
for n in 10 50 100
do
