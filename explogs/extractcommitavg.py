...
files = ["1metricslog.csv", "2metricslog.csv", "3metricslog.csv", "4metricslog.csv", "5metricslog.csv", "6metricslog.csv"]
...
for num, filename in enumerate(files, 1):
	...
	dftemp['totaltime'] = (dftemp['SuccTxCal'] + dftemp['FailTxCal'])/dftemp['CommThrput']
	dftemp['ActualCommThrput'] = (dftemp['SuccTxBC'] + dftemp['FailTxBC'])/dftemp['totaltime']
...
df['ActualCommThrputSE'] = dfstd['ActualCommThrputStdErr']
...
selectedcolumns =[ 'ExpNum', 'UseCase' , 'WorkloadType', 'RWProbability', 'TPS', 'TxDuration', 'KeyDistType', 'ZipSkew', 'PercentHotKeys', 'ProbHotKeys', 'BlockSize', 'NumOfOrgs', 'PeersPerOrg', 'EndorsePolicy', 'Database', 'succTxPercent', 'failTxPercent', 'TotCommTxBC', 'EndorseFailBCPercent', 'TotMVCCPercent', 'MVCCInterPercent', 'MVCCIntraPercent', 'PhantomReadPercent', 'NumOfCycles', 'OtherFailBCPercent', 'AvgEndoLat', 'AvgOrdValLat', 'AvgSuccLat', 'AvgCommLat', 'CommThrput', 'SuccThrput', 'ActualCommThrput', 'failTxPercentSE', 'succTxPercentSE', 'EndorseFailBCPercentSE', 'TotMVCCPercentSE', 'MVCCInterPercentSE', 'MVCCIntraPercentSE', 'PhantomReadPercentSE', 'OtherFailBCPercentSE', 'AvgEndoLatSE', 'AvgOrdValLatSE', 'AvgSuccLatSE', 'AvgCommLatSE', 'CommThrputSE', 'SuccThrputSE', 'ActualCommThrputSE']
